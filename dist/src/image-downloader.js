...
function isFileTypeAllowed(ext) {
 ...
 */
export async function downloadImageFromUrl(url, workspaceDir) {
    try {
 ...
 */
export async function downloadImagesFromUrls(urls, workspaceDir) {
