 ...
 */
export function getThreadSandbox(threadId) {
 ...
 */
export function getThreadMediaDir(threadId) {
 ...
 */
export function getThreadFilesDir(threadId) {
 ...
 */
export function validateSandboxPath(threadId, filePath) {
 ...
 */
export function enforceSandboxSizeLimit(threadId, maxSizeMB = getMaxSizeMB()) {
    const sandbox = getThreadSandbox(threadId);
 ...
 */
export function getSandboxSize(threadId) {
    const sandbox = getThreadSandbox(threadId);
    const files = listFilesRecursive(sandbox);
